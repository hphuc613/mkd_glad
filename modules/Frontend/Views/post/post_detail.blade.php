    ...
    <div class="container pt-3">
        <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ route('get.post.postListing') }}">最新消息</a></li>
        ...
        <section id="skincare" class="skincare">
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="recent">
                        <h5 class="recent-title">RECENT ARTICLES</h5>
                ...
                <div class="col-md-9">
                    <div class="article">
                        ...
                        <div class="divider">FEATURED PRODUCT</div>
